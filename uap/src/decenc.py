...
# NAO FUNCIONA DESENCRIPTAR CREDENTIALS.ECB E DEPOIS ENCRIPTAR CREDENTIALS.JSON(.BMP?)
if __name__ == "__main__":
    ...
    returned_key = decrypt(m, dm, password, 'AES', 'ECB')
    print(returned_key)
    
    encrypt(message, m, returned_key, 'AES', 'ECB')
